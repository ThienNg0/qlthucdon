...
public class frmSuaMonAn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSua.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/edit_icon_129126.png"))); // NOI18N
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if(ktso(dongia) == false){
            ...
            int ketqua = DAO.tbMonAn.SuaMonAn(Integer.parseInt(id), ten, Float.parseFloat(dongia));
        if(ketqua == -1){
